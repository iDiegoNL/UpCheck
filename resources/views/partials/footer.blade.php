        ...
        <div class="row">
            ...
            <div class="col-xl-auto mr-xl-5 col-md-3">
                ...
                <ul class="nav flex-row flex-md-column">
                    ...
                    <li class="nav-item mr-3 mr-md-0">
                        <a href="{{ route('privacypolicy') }}" class="nav-link fade-page px-0 py-2">Privacy Policy</a>
                    </li>
                    <li class="nav-item mr-3 mr-md-0">
                        <a href="{{ route('cookiepolicy') }}" class="nav-link fade-page px-0 py-2">Cookie Policy</a>
                    </li>
                    <li class="nav-item mr-3 mr-md-0">
                        <a href="{{ route('terms') }}" class="nav-link fade-page px-0 py-2">Terms and Conditions</a>
                    </li>
                    <li class="nav-item mr-3 mr-md-0">
