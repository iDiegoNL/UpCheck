...
<head>
    ...
    <meta name="description" content="UpCheck">

    <link href="{{ asset('home/css/bootstrap.css') }}" rel="stylesheet" type="text/css" media="all"/>
    <link href="{{ asset('home/css/stack-interface.css') }}" rel="stylesheet" type="text/css" media="all"/>
    <link href="{{ asset('home/css/socicon.css') }}" rel="stylesheet" type="text/css" media="all"/>
    <link href="{{ asset('home/css/lightbox.min.css') }}" rel="stylesheet" type="text/css" media="all"/>
    <link href="{{ asset('home/css/flickity.css') }}" rel="stylesheet" type="text/css" media="all"/>
    <link href="{{ asset('home/css/iconsmind.css') }}" rel="stylesheet" type="text/css" media="all"/>
    <link href="{{ asset('home/css/jquery.steps.css') }}" rel="stylesheet" type="text/css" media="all"/>
    <link href="{{ asset('home/css/theme.css') }}" rel="stylesheet" type="text/css" media="all"/>
    <link href="{{ asset('home/css/custom.css') }}" rel="stylesheet" type="text/css" media="all"/>
            ...
            <div class="row">
                <div class="col-lg-2 text-center text-left-sm hidden-xs order-lg-2">
                    <div class="bar__module">
                        <a href="index.html">
                            <img class="logo" alt="{{ config('app.name', 'Laravel') }}"
                                 src="{{ asset('images/logos/text-logo-2.png') }}"/>
                        </a>
                    </div>
                    <!--end module-->
                </div>
                                            ...
                                            <div class="col-md-12 dropdown__content dropdown__content--lg">
                                                <div class="pos-absolute col-lg-5 imagebg hidden-sm hidden-xs"
                                                    ...
                                                    <div class="container pos-vertical-center pl-5">
                                                        <div class="row">
                                                            <div class="col-lg-8">
                                                                <img alt="Logo" src="img/logo-light.png"
                                                                     class="image--xxs"/>
                ...
                <div class="col-lg-5 text-right text-left-xs text-left-sm order-lg-3">
                    <div class="bar__module">
                        @auth
                            <a class="btn btn--sm type--uppercase" href="{{ route('dashboard') }}">
                                    <span class="btn__text">
                                        Dashboard
                                    </span>
                            </a>
...
<script src="{{ asset('home/js/flickity.min.js') }}"></script>
<script src="{{ asset('home/js/easypiechart.min.js') }}"></script>
...
<script src="{{ asset('home/js/lightbox.min.js') }}"></script>
<script src="{{ asset('home/js/granim.min.js') }}"></script>
<script src="{{ asset('home/js/jquery.steps.min.js') }}"></script>
<script src="{{ asset('home/js/twitterfetcher.min.js') }}"></script>
<script src="{{ asset('home/js/spectragram.min.js') }}"></script>
