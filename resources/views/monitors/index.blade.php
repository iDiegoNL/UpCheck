                        ...
                        <tr>
                            ...
                            <td>
                                <a style="color: #495057;"
                                   href="{{ route('monitors.show', $monitor->id) }}">{{ $monitor->name }} <span
                                            class="badge badge-primary">{{ $monitor->id }}</span>
                                </a>
                            ...
                            <td class="text-center">
                                <div>{{ round(\App\Ping::where('monitor_id', $monitor->id)->avg('ms')) }} <span
