...
@section('content')
    <div data-overlay="" class="bg-primary-3 text-white o-hidden" style="padding-top: 80px !important;">
        ...
        <div class="position-absolute w-100 h-100 top left" data-jarallax-element="100" style="z-index: 0; transform: translate3d(0px, 7.73994px, 0px);">
            <div class="blob blob-2 bg-gradient top left w-75 h-75"></div>
            <div style="position: absolute; top: 0px; left: 0px; width: 100%; height: 100%; overflow: hidden; pointer-events: none; z-index: -100;" id="jarallax-container-0"><div style="position: fixed;"></div></div></div>
                ...
                <div class="col-sm-9 col-md-7 col-lg-4 mb-3 mb-md-4 mb-lg-0 aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                    <div class="card card-body align-items-center shadow">
                        ...
                        <div class="text-center mb-4">
                            ...
                            <div>Free forever, no strings attached</div>
                        </div>
                        <ul class="list-unstyled p-0">
                            <li class="my-3">
                                <div class="d-flex align-items-center">
                                    <div class="rounded-circle bg-success-alt">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="injected-svg m-2 icon icon-xs bg-success" data-src="assets/img/icons/interface/icon-check.svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            ...
                            <li class="my-3 opacity-50">
                                <div class="d-flex align-items-center">
                                    <div class="rounded-circle bg-danger-alt">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="injected-svg m-2 icon icon-xs bg-danger" data-src="assets/img/icons/interface/icon-x.svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <div class="row">
                    ...
                    <div class="px-xl-3">
                        <div>
                            <div class="d-inline-block mb-4 p-3 p-md-4 rounded-circle bg-primary-2-alt">
                                <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="injected-svg icon bg-primary-2" data-src="assets/img/icons/theme/navigation/route.svg">
                ...
                <div class="col-md-4 mb-4 mb-md-0 text-center">
                    <div class="px-xl-3">
                        <div>
                            <div class="d-inline-block mb-4 p-3 p-md-4 rounded-circle bg-primary-2-alt">
                                <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="injected-svg icon bg-primary-2" data-src="assets/img/icons/theme/layout/layout-left-panel-2.svg">
                ...
                <div class="col-md-4 mb-4 mb-md-0 text-center">
                    <div class="px-xl-3">
                        <div>
                            <div class="d-inline-block mb-4 p-3 p-md-4 rounded-circle bg-primary-2-alt">
                                <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="injected-svg icon bg-primary-2" data-src="assets/img/icons/theme/shopping/box-2.svg">
                        ...
                        <div class="card mb-2 mb-md-3">
                            <a href="#accordion-1" data-toggle="collapse" role="button" aria-expanded="false" class="p-3 p-md-4">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="injected-svg icon icon-sm" data-src="assets/img/icons/interface/icon-caret-right.svg" xmlns:xlink="http://www.w3.org/1999/xlink">
